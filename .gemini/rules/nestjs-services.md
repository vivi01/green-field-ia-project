---
title: Service Error Handling Rules
impact: HIGH
impactDescription: Prevents silent failures and keeps error propagation centralized in upper layers
tags: nestjs, services, error-handling, exceptions
---
