---
name: streamtube-project-guidelines
description: "**PROJECT SKILL** - Repository-wide conventions and architecture context for StreamTube. USE FOR: understanding the monorepo structure, branching rules, testing expectations, and project architecture. DO NOT USE FOR: implementation-specific NestJS, TypeORM, or frontend details."
license: MIT
metadata:
